...
public class VentanaReservaCentroPeriodica extends JFrame {
	...
	public VentanaReservaCentroPeriodica() {
		...
		JLabel lblReservaDeCentro = new JLabel(
				"Reserva de centro peri\u00F3dica");
	...
	public void insertarReserva() {
		if (rdbtnSemanal.isSelected()) {
			...
			JCheckBox checkMiercoles = (JCheckBox) panelSemanal
					.getComponents()[2];
			JCheckBox checkJueves = (JCheckBox) panelSemanal.getComponents()[3];
			JCheckBox checkViernes = (JCheckBox) panelSemanal
					.getComponents()[4];
			JCheckBox checkSabado = (JCheckBox) panelSemanal.getComponents()[5];
			JCheckBox checkDomingo = (JCheckBox) panelSemanal
					.getComponents()[6];
			...
			Long idInst = instalaciones
					.get(comboBoxInstalacion.getSelectedIndex()).getIdInst();
	...
	// setBounds(100, 100, 786, 525);
	//
	// JLabel lblReservaDeCentro = new JLabel("Reserva de centro
	// peri\u00F3dica");
	// lblReservaDeCentro.setHorizontalAlignment(SwingConstants.CENTER);
	// lblReservaDeCentro.setFont(new Font("Arial Black", Font.BOLD, 25));
	// getContentPane().add(lblReservaDeCentro, BorderLayout.NORTH);
	...
	// public void actionPerformed(ActionEvent arg0) {
	// ((CardLayout)
	// panelMostrarEleccion.getLayout()).show(panelMostrarEleccion,
	// "panelSemanal");
	// }
	// });
	// rdbtnSemanal.setFont(new Font("Tahoma", Font.PLAIN, 14));
